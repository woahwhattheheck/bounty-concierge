...
def _collect_issue_context_with_snapshot(
    ...
    *,
    ...
    """Collect qualification context and the exact issue generation it came from."""
...
def preflight_bounty(
    ...
    *,
    ...
    Issue-derived qualification metadata and canonical issue state are bound to
    one captured GitHub issue generation.  PR competition and maintainer
    comment reads remain live, but cannot splice a later issue payload into the
    dispatch decision.
    """
