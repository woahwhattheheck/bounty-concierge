...
class CanonicalSourceResolverTests(unittest.TestCase):
    ...
    def test_text_reference_suffix_contamination_does_not_resolve(self):
        hostile = (
    ...
    def test_text_reference_left_edge_contamination_does_not_resolve(self):
        hostile = (
    ...
    def test_clean_text_references_after_prose_delimiters_still_resolve(self):
        bodies = (
